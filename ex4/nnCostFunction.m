...
J(1) = (1/m)*sum(sum((-y_Vec.*log(h))-(1-y_Vec).*log(1-h))) + reg_term;

delta = zeros(size(y));

% ====================================================================
##
#### Backpropogation with for-loop
##for t = 1:m 
##  
####  layer 1
##   a1 = X(t,:)';
...
##  delta2 = delta2(2:end); %skip bias unit
##  
####  accumalating gradient by capital delta
